...
func (d *mockStressDriver) Init(cfg model.DriverConfig) error {
	return nil
}
...
func (d *mockStressDriver) Connect(ctx context.Context) error {
	return nil
}

func (d *mockStressDriver) Disconnect() error {
	return nil
}

func (d *mockStressDriver) IsConnected() bool {
	return true
}

func (d *mockStressDriver) Health() driver.HealthStatus {
	return driver.HealthStatusGood
}

func (d *mockStressDriver) SetSlaveID(slaveID uint8) error {
	return nil
}

func (d *mockStressDriver) SetDeviceConfig(config map[string]any) error {
	return nil
}
