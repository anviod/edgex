...
| **Siemens S7** | ✅ 已实现 | 完整支持 S7-200Smart/1200/1500/300/400 全系列 PLC；支持 DB、I/Q、M、T、C 内存区域 |
| **EtherNet/IP (ODVA)** | ✅ 已实现 | Rockwell PLC 全系列，Tag 地址格式批量读取 |
| **Omron FINS (TCP)** | 📅 规划中 | Q3 2026，欧姆龙 PLC 通信协议 |
| **DL/T645-2007** | 📅 规划中 | Q3 2026，多功能电能表通信协议 |
...
- **2026-06**:
  - **连接管理系统全面升级**: 公共 ConnectionManager 组件发布，全驱动统一连接管理
  - **采集健康检测**: 取消独立心跳机制，统一采集驱动检测
  - **EtherNet/IP 协议支持**: Rockwell PLC 全系列支持
