...
- ⏱️ **指数退避**：`backoff = min(base_delay × 2^retry_count, max_delay) + jitter`
- ❄️ **冷却期策略**：基础冷却 1 分钟，指数增长，最大 1 小时，防止持续打设备
...
| **DL/T645-2007** | `dlt645` | ⚠️ Stub | 已注册，模拟读写，真实协议开发中 |
| **Mitsubishi SLMP** | `mitsubishi-slmp` | ⚠️ Stub | 已注册，模拟读写，真实协议开发中 |
