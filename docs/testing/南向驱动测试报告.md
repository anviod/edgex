...
| `internal/driver/dlt645` | ⚠️ 无测试 | 0.0% | 仅 stub 注册 |
| `internal/driver/mitsubishi` | ⚠️ 无测试 | 0.0% | 仅 stub 注册 |
...
| DL/T645 | `dlt645` | 0 | 0 | 0.0% | ⚠️ stub |
| Mitsubishi SLMP | `mitsubishi-slmp` | 0 | 0 | 0.0% | ⚠️ stub |
