...
本文档所有设计必须与 [联机测试方案](./联机测试方案.md) 中的 35 个测试用例严格对齐。
...
详见 [联机测试方案 §3-4](./联机测试方案.md#3-编译与构建)，摘要：
...
**联机测试入口**：完成每个步骤后，执行 [联机测试方案](./联机测试方案.md) 中对应 Phase 的测试用例进行验证。
...
**配套文档**: [联机测试方案](./联机测试方案.md) — 编译部署 + 功能测试覆盖 + 35个测试用例