                        ...
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-select
                                    ...
                                    :items="['modbus-tcp', 'modbus-rtu', 's7', 'bacnet-ip']"
                                    label="协议"
                                    required
                                ></v-select>
                            </v-col>
                            ...
                            <v-col cols="12" v-if="dialog.form.protocol === 'modbus-tcp'">
                                <v-text-field v-model="dialog.form.config.url" label="URL (tcp://ip:port)"></v-text-field>
                            </v-col>
