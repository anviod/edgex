...
| 组件 | 说明 |
| :--- | :--- |
| **RTT 管理器** | 实时监测设备往返延迟，基于 EWMA 算法预测最优超时时间，动态调整采集间隔 |
| **MTU 管理器** | 自动探测设备最大传输单元，智能协商最优数据包大小，提升批量读取效率 |
| **Gap 优化器** | 根据设备特性动态调整通信间隙，平衡采集效率与设备负载 |
| **影子设备系统** | 统一内部数据模型中心，支持真实/虚拟影子设备，提供 WAL 持久化与一致性校验 |
| **智能画像** | 为每个设备建立通信画像，自动学习 RTT、MTU、稳定性等特征参数 |
| **采集调度器** | 基于设备画像优化采集顺序，支持批量读取优化和动态间隔调整 |
